'use client' // Client component yapıyoruz ki URL parametrelerini okuyabilelim
...
export default function LoginPage() {
  ...
  const message = searchParams.get('message') // URL'den mesajı yakala
  const error = searchParams.get('error')     // URL'den hatayı yakala
